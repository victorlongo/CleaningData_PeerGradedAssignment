...
setwd("/Users/victorlongo/Coursera/GCD/project/UCI HAR Dataset/test")
subject <- read.table("sub_test.txt")
...
setwd("/Users/victorlongo/Coursera/GCD/project/UCI HAR Dataset/train")
subject <- read.table("sub_train.txt")
subject <- subject %>% rename(subjectID = V1)
...
setwd("/Users/victorlongo/Coursera/GCD/project")
write.csv(totaldata, "totaldata.csv", row.names = FALSE)
write.csv(averages, "averages.csv", row.names = FALSE)
print("Two files were written in /Users/victorlongo/Coursera/GCD/project. 'totaldata.csv' is a dataset with the training and test sets and 'averages.csv' is a data set with the average of each variable for each activity and each subject. Also, two homonimous variables containing the data sets were created")
}
